    ...
    <div className="mx-7 mb-20">
      <div className="md:grid grid-cols-2">
        <div className="sm:mb-12 p-4 leading-[30px]">
          ...
          <br />
          <img src="src/assets/images/Vector 32.png" />
          <br />
          ...
          <img className="inline" src="src/assets/images/Play.png" />
          <span>View Demo</span>
        </div>

        <div className="mt-10">
          <img className="w-auto" src="src/assets/images/Group 138.png" />
        </div>
      </div>
      <br />
      ...
      <img className="mx-7" src="src/assets/images/Logo.png" alt="" />
    </div>
    </>
  );
}
